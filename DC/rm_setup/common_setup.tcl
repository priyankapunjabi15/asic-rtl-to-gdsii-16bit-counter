...
set DESIGN_NAME                   "updown_counter"  ;#  The name of the top-level design
...
set TARGET_LIBRARY_FILES          "$PDK_PATH/lib/stdcell_rvt/saed32rvt_ff1p16v125c.db"  ;#  Target technology logical libraries
